...
class MainMenuPage extends StatelessWidget {
              ...
              child: PageView.builder(
                  ...
                  itemBuilder: (context, index){
                    return GestureDetector(
                        ...
                        //child: _buildPageItem(index, list.data![index] as Advertising)
                        child: _buildPageItem2(index,_currPageValue)
                    );
                  }
              ),
            );
  ...
  Widget _buildPageItem2(int index,double _currPageValue) {
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              child: BigText(text: index.toString(),),
            ),
          )
        ],
      ),
