              ...
              ListView.builder(
                  ...
                  itemBuilder: (context,index){
                    ...
                    return GestureDetector(
                      onTap: (){
                        Get.to(() => MultiporpuseServiceForm(serviceType: controller!.pendingServicesList![index].JobType!,tokenTopic: controller!.pendingServicesList![index].TokenTopic!,multiporpuseJobDetail: controller!.pendingServicesList![index],),transition: Transition.rightToLeft,duration: Duration(milliseconds: 500));
                      },
                      child: Container(
