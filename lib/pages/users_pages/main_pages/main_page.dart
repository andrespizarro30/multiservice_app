...
import 'package:multiservice_app/pages/users_pages/main_pages/main_menu_all_options.dart';
import 'package:multiservice_app/pages/users_pages/service_required/accepted_services.dart';
import 'package:multiservice_app/pages/users_pages/service_required/pending_services.dart';
        ...
        builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
          if(snapshot.hasData){
            return GetBuilder<AuthenticationPageController>(builder: (authController){
              return (authController.uid != "" || authController.currentFBUserExists) && authController.signUpBody.userType == "Usuario" ?
              ...
              (authController.uid != "" || authController.currentFBUserExists) && authController.signUpBody.userType == "Tecnico" ?
              MainMenuAllOptionsTechnicians():
              SignInPage();
            });
          }else{
            return SignInPage();
